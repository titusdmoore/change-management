...
--
-- Host: db:3306
-- Generation Time: Aug 31, 2022 at 03:24 PM
...
--
ALTER TABLE `project`
  ADD CONSTRAINT `project_ibfk_1` FOREIGN KEY (`workspaceId`) REFERENCES `workspace` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
